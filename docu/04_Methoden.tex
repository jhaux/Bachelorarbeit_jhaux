...
\graph[./plot/finger_length.png]{Graphische Visualisierung der Arrayoperationen, welche zur Detektion und Längenbestimmung der Finger vorgenommen werden. Die Auflösung des Bildes im Hintergrund wurde künstlich heruntergesetzt.}{fig:lenarray}
