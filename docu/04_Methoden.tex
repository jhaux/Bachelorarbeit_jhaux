...
Im folgenden werden häufig die Begriffe ``Helligkeit'', ``Grauwert'' und ``Intensität'' benutzt. Sie bezeichnen alle die selbe Information: Den Grauwert \TODO{$i \geq 0$} eines Pixels, bzw. die Grauwerte eines Pixelarrays.
