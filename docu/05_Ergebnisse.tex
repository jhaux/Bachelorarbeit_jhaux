...
\graph[./plot/plots_data-1/fgrowth]{Länge der detektierten Finger im Verlauf des Experiments. Das Rauschen tritt auf, da die Methode nicht einwandfrei funktioniert. Siehe dazu auch Abbildung \ref{fig:f_detect}. Im Zeitraum zwischen \SIrange{9}{40}{\minute} liefert sie relativ verlässliche Ergebnisse.}{fig:fgrowth}
...
\graph[./plot/BCG_Test_Boro_num]{Farbumschläge des \BCGn. \BCG (1) in neutraler Form, \dah im Gleichgewicht mit der umgebenden Luft, (2) in Kombination mit gelöstem \COT. Man kann sehr gut den Ausschlag ins Gelbe erkennen. (3) mit den Glaskügelchen aus \BOG, (4) mit Glaskügelchen und gelöstem \COTn.}{fig:CPO_bor}
...
% ========================= longgraphpages =========================
\longgraphpage[./plot/plots_data-1/plot_all_overview_quot_0]{Fingerbildung im \COTm Experiment. Die Farbskala beschreibt die relative Absorption im Bezug auf den Hintergrund. Maximale Absorption bekommt den Wert 100 zugewiesen, minimale 0.}{fig:vcot_1-1}
\longgraphpage[./plot/plots_data-1/plot_all_overview_quot_1]{Fingerbildung im \COTm Experiment. Die Farbskala beschreibt die relative Absorption im Bezug auf den Hintergrund. Maximale Absorption bekommt den Wert 100 zugewiesen, minimale 0.}{fig:vcot_1-2}
